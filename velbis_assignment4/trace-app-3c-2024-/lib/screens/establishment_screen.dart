...
class _EstablishmentScreenState extends State<EstablishmentScreen> {
  ...
  late DateTime setDate = DateTime.now(); 
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                return FilteredDataWidget(documents: documents, setDate: setDate);
              },
            ),
          ),
        ],
...
class FilteredDataWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final filteredDocuments = documents.where((document) {
      ...
      final DateTime setDateTime = DateTime(setDate.year, setDate.month, setDate.day);
      return documentDate.isAtSameMomentAs(setDateTime);
    }).toList();
